...
// Arc maps 0%-50% risk to 0%-100% of the gauge. Anything ≥50% saturates.
const PD_CAP = 0.5
...
export function RiskGauge({ pd, riskBand }: Props) {
  const t = useT()
  ...
  const bandLabel =
    t.result.gauge.band[riskBand as keyof typeof t.result.gauge.band] ??
    riskBand.replace("_", " ")
    ...
    <div className="flex flex-col items-center">
      <div className="relative w-full max-w-[300px]">
        <svg
          ...
          aria-label={t.result.gauge.caption}
        >
          <defs>
          ...
          <path
            ...
            style={{
              transition:
                "stroke-dashoffset 800ms cubic-bezier(0.2, 0.8, 0.2, 1)",
