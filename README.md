...
Routes (regenerated by `scripts/sync_readmes.py`):
...
Regenerated by `scripts/sync_readmes.py` from `src/api/routers/*.py`. The
FastAPI-generated `/docs` and `/redoc` UIs sit alongside these.
